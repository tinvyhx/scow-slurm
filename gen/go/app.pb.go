...
func (m *GetAppConnectionInfoResponse) GetResponse() isGetAppConnectionInfoResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *GetAppConnectionInfoResponse) GetUseJobScriptGenerated() *GetAppConnectionInfoResponse_UseJobScriptGenerated {
	if x, ok := x.GetResponse().(*GetAppConnectionInfoResponse_UseJobScriptGenerated_); ok {
...
func (x *GetAppConnectionInfoResponse) GetAppConnectionInfo() *GetAppConnectionInfoResponse_AppConnectionInfo {
	if x, ok := x.GetResponse().(*GetAppConnectionInfoResponse_AppConnectionInfo_); ok {
...
func file_app_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAppConnectionInfoRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAppConnectionInfoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAppConnectionInfoResponse_UseJobScriptGenerated); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAppConnectionInfoResponse_AppConnectionInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
